...
- [ ] [s03t03](s03t03-add-edit-command-that-changed.md): add 'edit' command that changed --details (note: all fields, title and etc must be editable in future, see separate story)
