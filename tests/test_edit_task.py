...
def test_edit_details_on_file_task(s1: str) -> None:
...
def test_edit_details_upgrades_inline_task(s1: str) -> None:
...
def test_edit_title(s1: str) -> None:
...
def test_edit_title_on_inline_task(s1: str) -> None:
...
def test_edit_title_updates_parent_subtask_list(s1: str) -> None:
    t01 = add_subtask(s1, "Old title", details="Details").task_id
...
def test_edit_slug(s1: str) -> None:
...
def test_edit_multiple_fields(s1: str) -> None:
    t01 = add_subtask(s1, "Task A", details="Old details").task_id
    assert_invoke(
